/*
	...
	- Notes:
		* Cherry picked the 'View All Surfcams' feature, but discarded the newer stuff for the Shopify template
	    eg the ability to choose sitemap via inline attribute.
