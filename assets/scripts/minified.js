...
!function (e, t) {
  ...
  var n = [],
    ...
    var t,
      ...
      if ((e.ownerDocument || e) !== h && f(e), t = t.replace(q, "='$1']"), n.matchesSelector && m && !k[t + " "] && (!g || !g.test(t)) && (!v || !v.test(t))) try {
    ...
    return new Qe.prototype.init(e, t, n, i, r);
      ...
      var r,
          o,
          a,
          s = U(t);return Be.test(t) || (t = Xe(s)), (a = w.cssHooks[t] || w.cssHooks[s]) && "get" in a && (r = a.get(e, !0, n)), void 0 === r && (r = $e(e, t, i)), "normal" === r && t in ze && (r = ze[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r;
    ...
    w.cssHooks[t] = Re(p.pixelPosition, function (e, n) {
      if (n) return n = $e(e, t), Ye.test(n) ? w(e).position()[t] + "px" : n;
    });
  ...
  var e = Object.freeze({});function t(e) {
    ...
    return void 0 === $ && ($ = !B && !q && "undefined" != typeof global && global.process && "server" === global.process.env.VUE_ENV), $;
  },
    ...
    if (e.parent && (e.pre = e.pre || e.parent.pre), e.staticRoot && !e.staticProcessed) return Pa(e, t);if (e.once && !e.onceProcessed) return Na(e, t);if (e.for && !e.forProcessed) return ja(e, t);if (e.if && !e.ifProcessed) return Ia(e, t);if ("template" !== e.tag || e.slotTarget || t.pre) {
      if ("slot" === e.tag) return function (e, t) {
        ...
        var i = t.inlineTemplate ? null : $a(t, n, !0);return "_c(" + e + "," + Ya(t, n) + (i ? "," + i : "") + ")";
      }(e.component, e, t);else {
        var i;(!e.plain || e.pre && t.maybeComponent(e)) && (i = Ya(e, t));var r = e.inlineTemplate ? null : $a(e, t, !0);n = "_c('" + e.tag + "'" + (i ? "," + i : "") + (r ? "," + r : "") + ")";
    ...
    var n = function (e, t) {
      Yo = t.warn || Di, Wo = t.isPreTag || M, Bo = t.mustUseProp || M, qo = t.getTagNamespace || M, t.isReservedTag, Ho = ki(t.modules, "transformNode"), $o = ki(t.modules, "preTransformNode"), Ro = ki(t.modules, "postTransformNode"), Fo = t.delimiters;var n,
          i,
          r = [],
  ...
  watch: {
    ...
    return { value: null, options: [{ state: "Queensland", locations: [{ id: 876, name: "Duranbah", path: "duranbah.stream" }, { id: 484779, name: "Tweed Bar", path: "tweed-bar.stream" }, { id: 250741, name: "Snapper Rocks", path: "snapper-rocks.stream" }, { id: 250746, name: "Greenmount", path: "greenmount.stream" }, { id: 464936, name: "Kirra", path: "kirra.stream" }, { id: 343461, name: "Currumbin", path: "currumbin.stream" }, { id: 851, name: "Burleigh Heads", path: "burleigh.stream" }, { id: 473908, name: "Surfers Paradise South", path: "surfers-paradise-south.stream" }, { id: 473909, name: "Surfers Paradise North", path: "surfers-paradise-north.stream" }, { id: 351381, name: "Narrowneck", path: "narrowneck.stream" }, { id: 328776, name: "Kings Beach", path: "kings-beach.stream" }, { id: 896, name: "Moffat Beach", path: "moffat-beach.stream" }, { id: 328632, name: "Alex Headland", path: "alex-headland.stream" }, { id: 333699, name: "Coolum", path: "coolum.stream" }, { id: 334466, name: "Sunshine Beach", path: "sunshine-beach.stream" }, { id: 856, name: "Noosa Heads", path: "noosa.stream" }, { id: 468035, name: "Agnes Water", path: "agnes-water.stream" }] }, { state: "New South Wales", locations: [{ id: 328177, name: "Kingscliff", path: "kingscliff.stream" }, { id: 335898, name: "Cabarita", path: "cabarita.stream" }, { id: 866, name: "Byron Bay", path: "byron.stream" }, { id: 479345, name: "The Pass", path: "the-pass.stream" }, { id: 331984, name: "Yamba", path: "yamba.stream" }, { id: 329830, name: "Park Beach", path: "park-beach.stream" }, { id: 766, name: "Coffs Harbour", path: "coffs-harbour.stream" }, { id: 781, name: "Newcastle", path: "newcastle.stream" }, { id: 394603, name: "Avoca Beach", path: "avoca-beach.stream" }, { id: 776, name: "Narrabeen", path: "narrabeen.stream" }, { id: 771, name: "Manly", path: "manly.stream" }, { id: 761, name: "Bondi", path: "bondi.stream" }, { id: 881, name: "Maroubra", path: "maroubra.stream" }, { id: 786, name: "Shark Island", path: "shark-island.stream" }, { id: 886, name: "Cronulla Point", path: "cronulla-point.stream" }, { id: 891, name: "Cronulla Beaches", path: "cronulla-beaches.stream" }, { id: 473140, name: "Thirroul North", path: "thirroul-north.stream" }, { id: 841, name: "Thirroul", path: "thirroul.stream" }, { id: 791, name: "Wollongong", path: "wollongong.stream" }, { id: 472578, name: "Kiama", path: "kiama.stream" }] }, { state: "Victoria", locations: [{ id: 382063, name: "Woolamai", path: "woolamai.stream" }, { id: 861, name: "Torquay", path: "torquay.stream" }, { id: 477963, name: "Ocean Grove", path: "ocean-grove.stream" }, { id: 811, name: "Portsea", path: "portsea.stream" }, { id: 796, name: "13th Beach", path: "13th-beach.stream" }, { id: 488207, name: "Fairhaven", path: "fairhaven.stream" }, { id: 806, name: "Lorne", path: "lorne.stream" }, { id: 486859, name: "Lorne Point", path: "lorne-point.stream" }] }, { state: "South Australia", locations: [{ id: 816, name: "Knights", path: "knights.stream" }, { id: 871, name: "Middleton Bay", path: "middleton-bay.stream" }, { id: 444455, name: "Middleton Point", path: "middleton-point.stream" }, { id: 382064, name: "Triggs", path: "triggs.stream" }, { id: 382065, name: "Christies Beach", path: "christies-beach.stream" }, { id: 821, name: "South Port", path: "south-port.stream" }, { id: 444456, name: "Goolwa", path: "goolwa.stream" }] }, { state: "Western Australia", locations: [{ id: 846, name: "Margaret River", path: "margaret-river.stream" }, { id: 831, name: "Yallingup", path: "yallingup.stream" }, { id: 826, name: "Scarborough", path: "scarborough.stream" }] }] };
  }, watch: {
      ...
      console.info("Success. Sitemap fetched.");var i = n.data;i && (document.querySelectorAll("[data-render-nav-children]").forEach(function (n) {
        var r = parseInt(n.dataset.renderNavChildren),
          ...
          var _i2 = window.location.host,
              _r2 = "shop.swellnet.com" === _i2 || "shopdev.swellnet.com" === _i2 || "swellnet.local" === _i2 || -1 !== _i2.indexOf("yourwebvisual.com");var a = _r2 ? "https://www.swellnet.com" : "";!function n(i, r) {
...
});var _theatreMode = !1;_theatreMode = function theatreMode() {
  var e = $("#plyr-btn-expand"),
      t = $("small .text", e),
      n = $(".fa", e),
      i = $(".plyr__tooltip > .text", e),
      r = $(".page-heading"),
      o = $("#surfcam-player-plyr"),
      a = $("#surfcam-player-plyr-holder"),
