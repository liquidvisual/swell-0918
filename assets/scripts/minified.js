...
!function (e, t) {
  ...
  var t = window.location.pathname,
    ...
    axios.get(o, "", { headers: { Accept: "*/*" } }).then(function (n) {
      console.log("TEST: V16"), console.info("Success. Sitemap fetched.");var i = n.data;i && (document.querySelectorAll("[data-render-nav-children]").forEach(function (n) {
        var r = parseInt(n.dataset.renderNavChildren),
            o = i[r].children;if (o) {
          var _i2 = window.location.origin,
              _r2 = "https://shop.swellnet.com" === _i2 || "https://shopdev.swellnet.com" === _i2 || -1 !== _i2.indexOf("yourwebvisual.com");var a = _r2 ? "https://www.swellnet.com" : "";!function n(i, r) {
