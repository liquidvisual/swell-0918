...
!function (e, t) {
  ...
  var t = window.location.pathname,
    ...
    fetch(o).then(function (e) {
      ...
      console.log("SITEMAP JSON????"), console.log(n), console.log("EACH LOOP START!!!"), document.querySelectorAll("[data-render-nav-children]").forEach(function (e) {
        console.log("query selector all"), console.log(e);
      }), e("[data-render-nav-children]").each(function () {
        var i = e(this).data("render-nav-children");console.log("EACH LOOP, index: "), console.log(i), function n(i, r) {
